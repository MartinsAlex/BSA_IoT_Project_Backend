...
def current(name=None):
    LAUSANNE_LATITUDE = 46.52751093142267
    LAUSANNE_LONGITUDE = 6.626519003698495
    r_current = requests.get(f'https://api.openweathermap.org/data/2.5/weather?lat={LAUSANNE_LATITUDE}&lon={LAUSANNE_LONGITUDE}&appid=c6bbb95008347076780b7ce4a89f2224').json()
...
def createhtmlcurrent(current, pollution):
    ...
    air_quality_index = ((1 - pm10 / pm10_max) + (1 - no2 / no2_max) + (1 - o3 / o3_max) + (1 - pm25 / pm2_5_max)) / 4
